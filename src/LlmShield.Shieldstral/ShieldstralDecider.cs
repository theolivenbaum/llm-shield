...
/// </summary>
public sealed class ShieldstralDecider : IDisposable
{
    ...
    private ShieldstralDecider(MinistralModel model, bool ownsModel, ParallelOptions options,
    ...
    /// </param>
    public static async ValueTask<ShieldstralDecider> OpenAsync(
        string ggufPath, IReadOnlyDictionary<string, float>? temperature = null, ParallelOptions? options = null)
    {
        var decider = new ShieldstralDecider(new MinistralModel(ggufPath, initialCacheCapacity: 2048),
